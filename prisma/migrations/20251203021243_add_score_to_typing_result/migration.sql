...
INSERT INTO "new_TypingResult" ("accuracy", "correctKeystrokes", "courseId", "createdAt", "id", "mistakeCount", "mistakeDetails", "text", "totalKeystrokes", "userId", "wpm") SELECT "accuracy", "correctKeystrokes", "courseId", "createdAt", "id", "mistakeCount", "mistakeDetails", "text", "totalKeystrokes", "userId", "wpm" FROM "TypingResult";
